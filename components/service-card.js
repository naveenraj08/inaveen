...
export const ServiceCard = () => {
  return (
    <>
      <div className="service_card p-5 py-10 bg-slate-700 text-white col-span-12 rounded dev service-clay shadow-lg transition-all duration-300 hover:-translate-y-3 md:col-span-6 xl:col-span-3">
      ...
      <div className="service_card p-5 py-10 bg-slate-700 text-white col-span-12 rounded design service-clay shadow-lg transition-all duration-300 hover:-translate-y-3 md:col-span-6 xl:col-span-3">
        <div className="flex flex-col justify-center items-center mx-auto">
          <div>
            <svg width="60" height="60" x="0" y="0" viewBox="0 0 60 60">
              <g>
                <path
                  d="M43 0H17a5.006 5.006 0 0 0-5 5v50a5.006 5.006 0 0 0 5 5h26a5.006 5.006 0 0 0 5-5V5a5.006 5.006 0 0 0-5-5zM24 2h12v1a1 1 0 0 1-1 1H25a1 1 0 0 1-1-1zm22 53a3 3 0 0 1-3 3H17a3 3 0 0 1-3-3V5a3 3 0 0 1 3-3h5v1a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V2h5a3 3 0 0 1 3 3z"
                  fill="currentColor"
                ></path>
                <path
                  d="M37 54H23a1 1 0 0 0 0 2h14a1 1 0 0 0 0-2zM38 39a1 1 0 0 0 0-2h-6a1 1 0 0 0 0 2h2v8h-2a1 1 0 0 0 0 2h6a1 1 0 0 0 0-2h-2v-8zM22 37a1 1 0 0 0-1 1v7a4 4 0 0 0 8 0v-7a1 1 0 0 0-2 0v7a2 2 0 0 1-4 0v-7a1 1 0 0 0-1-1zM25 22a4 4 0 0 0 4-4v-7a1 1 0 0 0-2 0v7a2 2 0 0 1-4 0v-7a1 1 0 0 0-2 0v7a4 4 0 0 0 4 4zM31.485 21.857a1 1 0 0 0 1.372-.342L35 17.944l2.143 3.571a1 1 0 0 0 1.714-1.03L36.166 16l2.691-4.485a1 1 0 0 0-1.714-1.03L35 14.056l-2.143-3.571a1 1 0 0 0-1.714 1.03L33.834 16l-2.691 4.485a1 1 0 0 0 .342 1.372zM41.72 25.04l-24 7a1 1 0 1 0 .56 1.92l24-7a1 1 0 1 0-.56-1.92z"
                  fill="currentColor"
                ></path>
              </g>
            </svg>
